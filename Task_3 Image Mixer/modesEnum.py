...
class Modes(enum.Enum):
    ...
    UniformMagnitudeandPhase="testUniformMagAndPhase"
    magnitudeAndUniformPhase="testMagAndUniformPhase"
    UniformMagnitudeAndUniformPhase="testUniformMagAndUniformPhase"
